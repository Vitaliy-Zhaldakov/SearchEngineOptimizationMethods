...
class spherebee(bee.floatbee):
    """Функция - сумма квадратов по каждой координате"""

    # Количество координат
    count = 4

    # Задание начальных размеров для областей
    @staticmethod
    def getstartrange():
        return [150.0] * spherebee.count

    # Коэффициент уменьшения размеров областей
    @staticmethod
    def getrangekoeff():
        return [0.98] * spherebee.count

    def __init__(self):
        bee.floatbee.__init__(self)
...
class goldsteinbee(bee.floatbee):
...
class rosenbrockbee(bee.floatbee):
    """Функция Rosenbrock"""
